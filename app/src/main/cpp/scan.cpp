...
#include "com_armyof2_docscanner_ScanActivity.h"
...
vector<Point> getPoints(Mat image)
{
    ...
    /*//MyPy------------------------------------------
    //int lower_blue[] = {80, 40, 150};
    //int upper_blue[] = {120, 150, 230};
    ...
    inRange(image_hsv, Scalar(80, 40, 150), Scalar(120, 150, 230), mask);
    __android_log_write(ANDROID_LOG_INFO, "TAG", "Ok1");
    kernel = Mat::ones( 5, 5, CV_32F );
    __android_log_write(ANDROID_LOG_INFO, "TAG", "Ok2");
    morphologyEx(mask, opening, MORPH_OPEN, kernel);
    __android_log_write(ANDROID_LOG_INFO, "TAG", "Ok3");
    //------------------------------------------------*/
    ...
    for (int c = 0; c < 3; c++)
    {
        ...
        for (int l = 0; l < threshold_level; l++)
        {
            ...
            /*//MyPy--------------------------------------------
            Mat dilation;
            dilate(opening, dilation, kernel, Point(-1,-1), 16);
            Mat edges;
            Canny(opening, edges, 100, 200);
            dilate(edges, edges, kernel, Point(-1,-1), 1);
            __android_log_write(ANDROID_LOG_INFO, "TAG", "Ok4");
